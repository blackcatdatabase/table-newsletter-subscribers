...
final class NewsletterSubscribersAggregateService
{
    ...
    public function __construct(
        ...
        $this->repositories = [
  'newsletter_subscribers' => $this->newsletterSubscriberRepo
];
    }
    ...
    protected function withRowLock(callable $locker, int|string|array $id, callable $fetch, string $mode = 'wait'): mixed
    {
        ...
        return $this->txn(function () use ($locker, $id, $fetch, $mode) {
            ...
            if (!$row) {
                ...
                throw new \BlackCat\Database\Packages\NewsletterSubscribers\ModuleException("Record {$idStr} not found for locking.");
            }
