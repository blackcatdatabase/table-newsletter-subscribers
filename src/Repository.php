...
use BlackCat\Database\Packages\NewsletterSubscribers\Repository\NewsletterSubscriberRepository as GeneratedRepository;
...
{
  private NewsletterSubscriberRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof NewsletterSubscriberRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected NewsletterSubscriberRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\NewsletterSubscribers\Dto\NewsletterSubscriberDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\NewsletterSubscribers\Dto\NewsletterSubscriberDto|null { return $this->repo->getById($id, $asDto); }
