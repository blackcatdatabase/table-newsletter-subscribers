...
final class Repository
{
    ...
    {
        $this->repo = new NewsletterSubscriberRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\NewsletterSubscribers\Dto\NewsletterSubscriberDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\NewsletterSubscribers\Dto\NewsletterSubscriberDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\NewsletterSubscribers\Dto\NewsletterSubscriberDto|null
    {
