...
final class Definitions {
    ...
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'tenant_id', 'user_id', 'email_hash', 'email_hash_key_version', 'email_enc', 'email_key_version', 'confirm_selector', 'confirm_validator_hash', 'confirm_key_version', 'confirm_expires', 'confirmed_at', 'unsubscribe_token_hash', 'unsubscribe_token_key_version', 'unsubscribed_at', 'origin', 'ip_hash', 'ip_hash_key_version', 'meta', 'created_at', 'updated_at', 'version' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'tenant_id', 'email_hash' ], [ 'confirm_selector' ], [ 'id' ] ]; }
    ...
    public static function piiColumns(): array { return [ 'email_hash', 'ip_hash' ]; }
